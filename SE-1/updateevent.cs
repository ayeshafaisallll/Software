...
namespace mohsin
{
    public partial class updateevent : Form
    {
        ...
        public updateevent(int president_id)
        {
            InitializeComponent();

            // Set the president_id from the constructor parameter
            updateevent.president_id = president_id;

            label8.Text = "President ID: " + updateevent.president_id;
        ...
        {
            presidentview pv = new presidentview(0);
            pv.Visible = true;
            this.Visible = false;
        }
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO EventRequests (event_name,description, event_date,location,request_type,request_status,requested_by,society_id, target_event) " +
                                 "VALUES (@event_name, @description, @event_date, @event_location, @type, @status,@requested_by,@society_id, @target_event)";
